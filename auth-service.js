...
module.exports = {
  ...
  initialize: function () {
    return new Promise((resolve, reject) => {
      const db = mongoose.createConnection("mongodb+srv://panchaljaidev26:Ms1jYYPW5w5F2z6Z@cluster0.ft57e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"); // Replace with your MongoDB connection string
